...
curl -s http://127.0.0.1:8000/v1/responses \
  -H "Authorization: Bearer test-key" \
  -H "Content-Type: application/json" \
  -d '{"input":"What models are installed?","tools":[{"type":"function","name":"list_installed_models","parameters":{"type":"object","properties":{},"additionalProperties":false}}],"tool_choice":"auto","tool_execution":"server"}'
